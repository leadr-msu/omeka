...
* Once added, new users are supposed to each recieve an email with steps for getting their account set-up completed; however, this doesn't always seem to happen.
* As a workaround, you will need to register each user with a personalized username and a general password.
